...
an image with the indices corresponding to the category with the highest membership
value at each pixel, and a matrix with the membership values to the 11 basic color 
